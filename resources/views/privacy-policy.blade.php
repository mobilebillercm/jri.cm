...
<div class="page">
    ...
    <section class="breadcrumbs-custom bg-image context-dark scroll-handler" style="background-image: url(images/bg-breadcrumbs.jpg);">
        ...
        <div class="breadcrumbs-main">
            <div class="container">
                <h2 class="breadcrumbs-custom-title scroll-title">Privacy policy</h2>
            </div>
        </div>
    ...
    <section class="section section-lg bg-default">
        <div class="container">
            ...
            </dl><a class="privacy-link" href="/cdn-cgi/l/email-protection#8dae"><span class="__cf_email__" data-cfemail="d7a7a5bea1b6b4ae97b3b2bab8bbbeb9bcf9b8a5b0">[email&#160;protected]</span></a>
        </div>
    </section>
                    ...
                    <div class="col-md-3">
                        <div class="inset-xl-left-70">
                            ...
                            <ul class="contacts-modern">
                                ...
                                <li><a href="tel:#">+1 800 123 1234</a><br><a href="/cdn-cgi/l/email-protection#e7c4"><span class="__cf_email__" data-cfemail="1c75727a735c787971737075727732736e7b">[email&#160;protected]</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
